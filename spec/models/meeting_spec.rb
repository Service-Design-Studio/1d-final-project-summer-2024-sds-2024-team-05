...
RSpec.describe Meeting, type: :model do
  ...
  describe '#readable_datetime' do
    it 'returns the formatted date and time' do
      meeting.start_time = DateTime.new(2024, 7, 25, 10, 0, 0)
      expect(meeting.readable_datetime).to eq('25 July 2024,  6:00pm')
    end
  end
  ...
  describe '#overflow_date' do
    it 'returns the day and formatted datetime with a line break' do
      meeting.start_time = DateTime.new(2024, 7, 25, 10, 0, 0)
      expect(meeting.overflow_date).to eq("Thu, <br> 25 July 2024,  6:00pm")
    end
  end
  ...
  describe '#inline_date' do
    it 'returns the day and formatted datetime inline' do
      meeting.start_time = DateTime.new(2024, 7, 25, 10, 0, 0)
      expect(meeting.inline_date).to eq("Thu, 25 July 2024,  6:00pm")
    end
  end
  ...
  describe '#condensed_time' do
    it 'returns the time in 12-hour format' do
      ...
      expect(meeting.condensed_time).to eq('10:00 PM')
    end
  end
  ...
  describe '#parsed_start_time' do
    it 'returns the start time in HH:00 format' do
      ...
      expect(meeting.parsed_start_time).to eq('22:00')
    end
  end

  describe '#hours' do
    it 'returns an array of times from 08:00 to 22:00' do
      expect(meeting.hours).to eq(['08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', "20:00", "21:00", "22:00"])
    end
  end
end