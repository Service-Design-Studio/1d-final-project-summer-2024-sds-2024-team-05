...
Rails.application.routes.draw do
  ...
  resources :forms, controller: 'patients' do
    member do
      ...
      get 'edit_physical_assessment', to: 'admins#physical_assessment'
      patch 'edit_physical_assessment', to: 'admins#update_physical_assessment'
      get 'edit_mental_assessment', to: 'admins#mental_assessment'
      patch 'edit_mental_assessment', to: 'admins#update_mental_assessment'
      get 'edit_environment_assessment', to: 'admins#environment_assessment'
